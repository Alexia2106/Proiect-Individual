                ...
                <div class="row">
                  <div class="col-md-7">
                    <div class="detail-box">
                      ...
                      <p>
                        Reînnoiește-ți garderoba cu produsele noastre de înaltă calitate, alese cu grijă și la un preț avantajos!
                      </p>
                      <a href="contact.php">
                        Contactează-ne
                      </a>
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-7">
                    <div class="detail-box">
                      <p>
                        Apreciem grija ta pentru mediu! Te invităm să descoperi produsele noastre second-hand, inclusiv haine, pantofi și accesorii, toate într-o stare perfectă. 
                        Prin achiziționarea acestor articole, nu numai că îți completezi garderoba cu elemente de calitate, dar contribui și la reciclarea responsabilă, având un impact benefic asupra mediului înconjurător.
                         Alătură-te misiunii noastre de a face alegeri sustenabile și de a sprijini un mod de viață prietenos cu planeta!
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                prin poștă, easybox sau orice curierat
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                indiferent de prețul total al comenzii
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                iar pe lângă asta, contribui și la reciclarea responsabilă 
              </p>
            </div>
          </div>
        </div>
